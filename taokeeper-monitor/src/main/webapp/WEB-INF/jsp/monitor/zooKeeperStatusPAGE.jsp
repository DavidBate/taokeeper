		...
		<c:forEach var="zooKeeperStatus" items="${zooKeeperStatusMap}">
			<tr>
				...
				<td>${ zooKeeperStatus.value.sent }/${
					zooKeeperStatus.value.received }</td>
...
<h1>ZooKeeper延时监控<font size="2">
		更新时间：${timeOfUpdateDelay}</font><font size="2"></h1> 
...
<h1>ZooKeeper实时RT监控<font size="2">
		更新时间：${timeOfRTUpdate}</font><font size="2"></h1> 
<table border="0" cellspacing="0" cellpadding="0" style="">
	<tr>
		<th>服务器</th>
		<th>createSession</th>
	...
	<c:forEach var="rtInfo" items="${rtInfoMap}">
		<tr>
			<td>${ rtInfo.key }</td>
			<td>${rtInfo.value.createSession }</td>
			<td>${rtInfo.value.createNode }</td>
			<td>${rtInfo.value.exists }</td>
			<td>${rtInfo.value.setData }</td>
			<td>${rtInfo.value.getData }</td>
			<td>${rtInfo.value.delete }</td>
			<td>${rtInfo.value.getChildren }</td>
		</tr>
	</c:forEach>
</table>
